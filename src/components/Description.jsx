const Description = ({ Question }) => {
  return (
    <>
      {/* Title + Solved Badge */}
      <div className="flex items-center gap-2 text-2xl sm:text-3xl md:text-4xl font-bold text-[#CAFF33]">
      ...
      {/* Description */}
      <div className="mt-4 p-4 rounded-lg bg-[#1C1C1C]/60 border border-[#CAFF33]/40">
      ...
      {/* Input Format */}
      <div className="mt-4 p-4 rounded-lg bg-[#1C1C1C]/60 border border-blue-400/40">
      ...
      {/* Output Format */}
      <div className="mt-4 p-4 rounded-lg bg-[#1C1C1C]/60 border border-purple-400/40">
      ...
      {/* Constraints */}
      <div className="mt-4 p-4 rounded-lg bg-[#1C1C1C]/60 border border-red-400/40">
